...
void cDropEvent::dropItem(int aIndex, BYTE MapNumber, BYTE x, BYTE y, int LootIndex, s_DropEventItem&i)
{
    ...
    Log.ConsoleOutPut(1,c_Green,t_DROP,"[Event DROP] [%d]\t%d %d %d %d %d %d %d %d",(int)MapNumber,i.iGroup,i.iId,i_lvl,i_luck,i_skill,i_opt,i_exc,i_anc);
}
...
void cDropEvent::updateIT()
{
    ...
    while(!feof(fp))
    {
        ...
        {
            sscanf_s(Line, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &lineDropIT.dropRate, &lineDropIT.iGroup, &lineDropIT.iId, &lineDropIT.minLvl, &lineDropIT.maxLvl, &lineDropIT.dur, &lineDropIT.skill, &lineDropIT.luck, &lineDropIT.minOpt, &lineDropIT.maxOpt, &lineDropIT.exc, &lineDropIT.minExc, &lineDropIT.maxExc, &lineDropIT.anc, &lineDropIT.ancType);
...
void cDropEvent::updateCC()
{
    ...
    while(!feof(fp))
    {
        ...
        {
            sscanf_s(Line, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &lineDropCC.dropRate, &lineDropCC.iGroup, &lineDropCC.iId, &lineDropCC.minLvl, &lineDropCC.maxLvl, &lineDropCC.dur, &lineDropCC.skill, &lineDropCC.luck, &lineDropCC.minOpt, &lineDropCC.maxOpt, &lineDropCC.exc, &lineDropCC.minExc, &lineDropCC.maxExc, &lineDropCC.anc, &lineDropCC.ancType);
