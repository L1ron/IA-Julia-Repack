...
#define gObjCheckTeleportArea	((int(*)	(int aIndex, BYTE X, BYTE y))			0x00539BE0)
//#define GDGuildServerGroupChattingSend ((void(*)(int iGuildNum, PMSG_CHATDATA* lpChatData)) 0x0046E050)
//#define GDUnionServerGroupChattingSend ((void(*)(int iUnionNum, PMSG_CHATDATA* lpChatData)) 0x0046E2A0)
...
#define gObjInventoryMoveItem ((byte(*)(int aIndex, BYTE source, BYTE target, int& durSsend, int& durTsend, BYTE sFlag, BYTE tFlag, LPBYTE siteminfo)) 0x00530FE0)
#define CGItemDropRequest ((bool(*)(PMSG_ITEMTHROW * lpMsg, int aIndex, BOOL drop_type)) 0x004427B0)
...
#define GCInventoryItemOneSend ((void(*) (int, int)) 0x0043F250)
#define gObjSetBP ((void(*)(DWORD))0x00401D1B)
#define GCReFillSend ((void(*)(int, WORD, BYTE, unsigned char, WORD))0x00404D90)
#define GCManaSend ((void(*)(DWORD, DWORD, DWORD, DWORD, DWORD))0x00402F9F)
//#define GDGuildServerGroupChattingSend ((void(*)(int iGuildNum, PMSG_CHATDATA* lpChatData)) 0x00473D10)
//#define GDUnionServerGroupChattingSend ((void(*)(int iUnionNum, PMSG_CHATDATA* lpChatData)) 0x00473F60)
#define PChatProc ((void(*)(PMSG_CHATDATA* lpChat, short aIndex)) 0x0043C360)
#define ItemDurRepaire ((void(*)(LPOBJ lpObj, CItem * DurItem, int pos, int RequestPos)) 0x0044A310)
#define gObjCheckTeleportArea	((int(*)	(int aIndex, BYTE X, BYTE y))			0x0054CB40)
...
#define GS_GUILDALLIANCE2		(0x00467E67+2)
...
#define GS_GFNORMAL02				(0x004DAD87+1) // Inner Strenght Energy Div
...
// a Speed
#define AttackSpeed_Elf1					(0x004E9D83+1)
#define AttackSpeed_Elf2					(0x004E9D97+1)
#define AttackSpeed_DK_MG1					(0x004E9DD2+1)
#define AttackSpeed_DK_MG2					(0x004E9DE6+1)
#define AttackSpeed_DL1						(0x004E9E10+1)
#define AttackSpeed_DL2						(0x004E9E24+1)
#define AttackSpeed_DW1						(0x004E9E4B+1)
#define AttackSpeed_DW2						(0x004E9E5F+1)
#define AttackSpeed_Sum1					(0x004E9E75+1)
#define AttackSpeed_Sum2					(0x004E9E89+1)
...
#define GS_GUILDALLIANCE2		(0x00468E27+2)
...
#define GS_GFNORMAL02               (0x004EC117+1)
...
#define GSCS_LORDMIX_MAXUSE         0x00801068
...
// a Speed
#define AttackSpeed_Elf1					(0x004FB923+1)
#define AttackSpeed_Elf2					(0x004FB937+1)
#define AttackSpeed_DK_MG1					(0x004FB972+1) 
#define AttackSpeed_DK_MG2					(0x004FB986+1)
#define AttackSpeed_DL1						(0x004FB9B0+1)
#define AttackSpeed_DL2						(0x004FB9C4+1)
#define AttackSpeed_DW1						(0x004FB9EB+1)
#define AttackSpeed_DW2						(0x004FB9FF+1)
#define AttackSpeed_Sum1					(0x004FBA15+1)
#define AttackSpeed_Sum2					(0x004FBA29+1)
...
struct _GUILD_INFO_STRUCT
{
    ...
    int  GetGuildUnion() {
        return this->iGuildUnion;
    };
    int  GetGuildRival() {
        return this->iGuildRival;
    };
